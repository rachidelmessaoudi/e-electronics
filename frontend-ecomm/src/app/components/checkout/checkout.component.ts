...
import {ElectronicValidators} from '../../validators/electronic-validators';
...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      customer: this.formBuilder.group({
        firstName: new FormControl('',
                                    [Validators.required,
                                                  ...
                                                  ElectronicValidators.notOnlyWhitespace]),
    ...
    //populate countries
    this.electronicsFormService.getCountries().subscribe(
      data=>{
  ...
  onSubmit(){
    ...
    for (let i=0;i<cartItems.length;i++){
      ...
      //-shart way of doing the same thingy
  ...
  getStates(formGroupName: string) {
    ...
    this.electronicsFormService.getStates(countryCode).subscribe(
      data=>{
